...
@section('content')
	<div class="row mt-16">
		<div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 col-sm-12 col-xs-12">
			<h3>Making Money Begins With a Value Idea</h3>
			<p>When you start to build your affiliate marketing network, it is very important that you give something of value to your audience in exchange for their contact information. If they love what you're giving them, they'll invite their friends too and help you grow!</p>
			<p>For example, if you knew a lot about cars and your audience consists of car enthusiasts, something they <b>might</b> value is learning more about cars.</p>
			<p>Note that "might" exists in that sentence. We don't know exactly if that's something that your audience wants and that's where our software can help you test using the power of artificial intelligence.</p>
		...
		<div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 col-sm-12 col-xs-12">
			<form action="/onboarding/create-idea" method="post" id="create_idea_form">
				...
				<div class="row">
					...
					<div class="col-lg-4 offset-lg-4 col-md-6 offset-md-3 col-sm-12 col-xs-12 mt-16">
